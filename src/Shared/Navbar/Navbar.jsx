      ...
      <div className="navbar max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        ...
        <div className="navbar-start flex items-center">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu dropdown-content mt-2 z-[999] p-2 shadow-lg bg-white rounded-lg w-64 sm:w-72 space-y-1"
            >
              {navLinks}
              {!user ? (
                <>
          ...
          <NavLink
            to="/"
            className="flex items-center gap-2 text-xl sm:text-2xl font-bold tracking-tight text-primary btn btn-ghost normal-case"
          >
